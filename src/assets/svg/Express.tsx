...
const Express = ({className, ...props}: SVGProps<SVGSVGElement>) =>
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="1em" height="1em" {...props}>
