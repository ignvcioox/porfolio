...
const MySQL = ({className, ...props}: SVGProps<SVGSVGElement>) =>
    <svg className={className} xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 252" width="1em" height="1em" {...props}>
