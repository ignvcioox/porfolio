...
const Expo = ({ className, ...props }: SVGProps<SVGSVGElement>) =>
    <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 231" width="1em" height="1em" className={className} {...props}>
